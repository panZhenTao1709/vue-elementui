<template>
  <div class="app-container">
    ...
    <el-card class="box-card" shadow="never">
      <eHeader :sup_this="sup_this" :style="style" />
      <el-table
        :data="tableData"
        :load="load"
        ...
        <el-table-column sortable prop="companyName" :label="this.$t('table.companyName')"/>
  ...
  export default {
    ...
    methods: {
      ...
      init(query){
        ...
        initData('cloud-admin/adminRole/children',query).then(res => {
          _this.tableData = res
        })
      },
      load(tree, treeNode, resolve) {
        initData('cloud-admin/adminRole/children', {parentId: tree.id}).then(res => {
          resolve(res)
        })
      },
