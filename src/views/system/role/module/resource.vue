<template>
  <div>
    <el-dialog v-dialogDrag :visible.sync="dialog" title="权限分配" append-to-body width="500px" style="height:100%;overflow:hidden;">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="text" @click="this.dialog = false">{{ $t('btn.cancel') }}</el-button>
...
<script>
  ...
  import {getJudgedResource, saveResource} from '@/api/role'
